...
## Objective
The goal of this project is to analyze fraud transactions by clients, categories and card types for derive insights, financial planning with financial health indicators for customer seqmentation for enhance decision making.
...
2. **Customer seqmentation:** discovered that in 2019, recent year analyzed, customer financial planning could be devided into 3 criteria based on financial health indicators. Among all customers, the **Fair** criteria had the highest proportion at **80.70%**, followed by **Excellent** at **13.15%**, and Improve at **6.15%** respectively.
